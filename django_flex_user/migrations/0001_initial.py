    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', django.contrib.postgres.fields.citext.CICharField(blank=True, error_messages={'unique': 'A user with that username already exists.'}, help_text='150 characters or fewer. Letters, digits and ./-/_ only.', max_length=150, null=True, unique=True, validators=[django_flex_user.validators.SPUnicodeUsernameValidator()], verbose_name='username')),
