...
class TestUserSerializer(TestCase):
    ...
    def test_update_duplicate_email(self):
        ...
        user = SPUser.objects.create_user(email='validEmail@example.com', password='validPassword')
        SPUser.objects.create_user(email='validEmail2@example.com', password='validPassword')
    ...
    def test_update_duplicate_phone_number(self):
        ...
        user = SPUser.objects.create_user(phone_number='+12025551234', password='validPassword')
        SPUser.objects.create_user(phone_number='+12025554321', password='validPassword')
